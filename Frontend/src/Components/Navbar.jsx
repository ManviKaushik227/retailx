...
export default function Navbar() {
  ...
  // ✅ fetchCart ko context se nikala taaki login pe call kar sakein
  const { cartData, fetchCart } = useContext(CartContext);

  // ✅ Cart count logic (Quantity sum)
  ...
  useEffect(() => {
    ...
    // ✅ FIX: Agar user logged in hai, toh turant cart fetch karo
    // Isse login ke baad badge hamesha updated rahega
    if (storedUser) {
      fetchCart();
    }
  }, [fetchCart]); // fetchCart dependency zaroori hai
  ...
  const handleLogout = () => {
    ...
    setUser(null);
    navigate("/");
    // Logout pe state clear karne ke liye reload best hai
      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* ✅ DYNAMIC CART ICON: Ab ye login ke sath hi update hoga */}
